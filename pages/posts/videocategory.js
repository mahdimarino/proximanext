...
const Videocategory = () => {
    return (
        <Row style={{ backgroundColor: 'black' }} className='p-5 m-5 d-flex justify-content-center'>
            ...
            <Col xl={6} md={12}>
                <iframe width="560" height="315" src="https://www.youtube.com/embed/CYC4SRMmS8o" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            </Col>
            <Col xl={6} md={12}>
